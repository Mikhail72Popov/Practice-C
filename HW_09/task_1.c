...
Данные на входе:Два слова из маленьких английских букв через пробел. Длинна
каждого слова не больше 100 символов.
...
int main(void)
{
	...
	char str_w2[26] = {0};
	char str_end[26] = {0};
    char * filename_read = "input_1.txt";
    char * filename_write = "output_1.txt";
